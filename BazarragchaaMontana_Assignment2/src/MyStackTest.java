...
public class MyStackTest {
	...
	public void testPushStudent() {
        ...
        try {
            ...
            assertEquals(true, doubleS.push(1.6)); 
            ...
            doubleS.push(6.4);
            fail("StackOverflowException"); 
        } catch (StackOverflowException e) {
            
            assertTrue("StackOverflowException", true);
        } catch (Exception e) {
            fail("failed"); 
        }
	}
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
        assertEquals("0.20.40.8", doubleS.toString()); 
        doubleS.push(1.6);
        assertEquals("0.20.40.81.6", doubleS.toString()); 
        doubleS.push(3.2);
        assertEquals("0.20.40.81.63.2", doubleS.toString()); 
	}
